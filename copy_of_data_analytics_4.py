# -*- coding: utf-8 -*-
"""Copy of Data_Analytics_4

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1o9RTco0wXzy7OhUc8-C1F-_fmPSVNTgA
...
allpred=all_vs_all(train,"SVM",xtest)
# allpred=all_vs_all(train,"DecisionTree",xtest,ytest)
# allpred=all_vs_all(train,"RandomForest",xtest,ytest)
# allpred=all_vs_all(train,"LogisticRegression",xtest,ytest)
# allpred=all_vs_all(train,"KNN",xtest,ytest)
preds=voting(allpred)
print(accuracy(preds,ytest))

best_model="SVM"
testdf=pd.read_csv("penguins_test.csv")
